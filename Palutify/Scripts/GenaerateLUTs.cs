...
public class BasicTests : MonoBehaviour
{
    ...
    private delegate void ProcessPixel(BasicTests test);
    ...
    private static void ProcessPixelHSV(BasicTests tests)
    {
    ...
    private static void ProcessPixelRGB(BasicTests tests)
    {
        tests.r = tests.counter % COLOR_INT;
        tests.g = (tests.counter / COLOR_INT) % COLOR_INT;
        tests.b = tests.counter / COLOR_INT_SQ;
    ...
    private static void ProcessPixelHRGB(BasicTests tests)
    {
        tests.r = tests.counter % COLOR_INT;
        tests.g = (tests.counter / COLOR_INT) % COLOR_INT;
        tests.b = tests.counter / COLOR_INT_SQ;
    ...
    private static void ProcessPixelHybrid(BasicTests tests)
    {
        tests.r = tests.counter % COLOR_INT;
        tests.g = (tests.counter / COLOR_INT) % COLOR_INT;
        tests.b = tests.counter / COLOR_INT_SQ;
    ...
    private static void ProcessPixelNeutral(BasicTests tests)
    {
        tests.r = tests.counter % COLOR_INT;
        tests.g = (tests.counter / COLOR_INT) % COLOR_INT;
        tests.b = tests.counter / COLOR_INT_SQ;
